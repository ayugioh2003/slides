...
<!-- .slide: data-background="https://i.imgur.com/1GpMIfa.png"  -->
...
- 認為人的心智歷程，就是資訊的處理過程 <!-- .element: class="fragment  " -->
- 接收資訊→大腦處理資訊→用語言表達 <!-- .element: class="fragment  " -->
...
- 點心 @門口 <!-- .element: class="fragment" data-fragment-index="1" -->
- 鋼彈 @客廳<!-- .element: class="fragment" data-fragment-index="1" -->
- 荔枝 @餐桌<!-- .element: class="fragment" data-fragment-index="1" -->
- 外星人 @廚房<!-- .element: class="fragment" data-fragment-index="1" -->
- 大雄翻花繩打結 @房間<!-- .element: class="fragment" data-fragment-index="1" -->
...
<!-- .slide: data-background="https://i.imgur.com/Ln1STZp.jpg"  -->
...
|          | 記憶表現的比較     | 相關資料          |
| -------- | ------------------ | ----------------- |
| 短期儲存 | <b>聽覺</b> > 語意 > 視覺 | <small>(Baddely, 1966)</small>   |
| 長期儲存 | <b>語意</b> > 視覺、聽覺  | <small>(Vousfield, 1953)</small> |

--

2-1 收錄的形式 小結

* 短時間內快速記住 → <b>聽覺</b> <!-- .element: class="fragment "--> 
* 長時間持續記住 → <b>語意</b> <!-- .element: class="fragment "--> 
...
* 訊息從短期記憶轉移到長期記憶<!-- .element: class="fragment " data-fragment-index="1"--> 
* 固化：刻意專注於訊息並理解它<!-- .element: class="fragment " data-fragment-index="2"--> 
* 複誦、記憶術技巧<!-- .element: class="fragment " data-fragment-index="3"--> 
...
- @門口 <span>點心</span> <!-- .element: class="fragment"  -->
- @客廳 <span>鋼彈</span> <!-- .element: class="fragment"  -->
- @餐桌 <span>荔枝</span> <!-- .element: class="fragment"  -->
- @廚房 <span>外星人</span> <!-- .element: class="fragment" -->
- @房間 <span>大雄翻花繩打結</span> <!-- .element: class="fragment"  -->
...
* 把概念的字頭湊成一個句子
* 腦神經：嗅室動滑三歪顏 聽舌迷腹舌<!-- .element: class="fragment"  -->
* 八國聯軍：餓的話 每日熬一鷹<!-- .element: class="fragment"  -->
